...
export default function CommunityDetail() {
  ...
  const deletePostMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      if (error.message?.includes('403')) displayDescription = "작성자만 게시글을 삭제할 수 있습니다.";
      else if (error.message?.includes('500') || error.message?.includes('Database')) displayDescription = "게시글 삭제 중 서버 오류가 발생했습니다. 잠시 후 다시 시도해 주세요.";
      toast({
        title: "게시글 삭제 실패",
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      toast({ title: "복사 실패", description: "URL을 복사하는데 실패했습니다.", variant: "destructive" });
    }
  };
      ...
      <header className="bg-white border-b px-4 py-3 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-center flex-1">
            ...
            <h1 className="text-lg font-semibold text-gray-900">{post.category}</h1>
          </div>
                ...
                <>
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="focus:bg-gray-100">
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={handleDeletePost} disabled={deletePostMutation.isPending} className="bg-red-500 hover:bg-red-600">
                          삭제
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
                        ...
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            {canDelete && (
                              <AlertDialog>
                                <AlertDialogTrigger asChild>
                                  <Button variant="ghost" size="sm" className="p-1 h-6 w-6 text-gray-500 hover:bg-gray-100">
